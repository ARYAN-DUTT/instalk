...
// On Railway or Neon: DATABASE_URL is set automatically or loaded from .env
const pool = new Pool({
  connectionString: process.env.DATABASE_URL,
  ssl: process.env.DATABASE_URL && (process.env.DATABASE_URL.includes("railway") || process.env.DATABASE_URL.includes("neon.tech"))
